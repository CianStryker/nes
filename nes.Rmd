...
ggplot(y, aes(x = pred_gender, y = partyid7, group = pred_gender)) +
  geom_boxplot()
...
fit_y <- stan_glm(partyid7 ~ gender + race + real_ideo, data = x, refresh = 0)

fit_x <- stan_glm(partyid7 ~ gender + race + realideo, data = x, refresh = 0)
```
